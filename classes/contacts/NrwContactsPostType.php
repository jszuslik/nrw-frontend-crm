...
class NrwContactsPostType {
	...
	function nrw_contacts_post_type() {
		...
		$labels = array(
			...
			'all_items'             => __( 'All Contacts', 'nrw-frontend-crm' ),
			'add_new_item'          => __( 'Add New Contact', 'nrw-frontend-crm' ),
			'add_new'               => __( 'Add New Contact', 'nrw-frontend-crm' ),
			'new_item'              => __( 'New Contact', 'nrw-frontend-crm' ),
			'edit_item'             => __( 'Edit Contact', 'nrw-frontend-crm' ),
			'update_item'           => __( 'Update Contact', 'nrw-frontend-crm' ),
			'view_item'             => __( 'View Contact', 'nrw-frontend-crm' ),
			'view_items'            => __( 'View Contacts', 'nrw-frontend-crm' ),
			'search_items'          => __( 'Search Contact', 'nrw-frontend-crm' ),
			...
			'items_list'            => __( 'Contacts list', 'nrw-frontend-crm' ),
			'items_list_navigation' => __( 'Contacts list navigation', 'nrw-frontend-crm' ),
